    ...
    return (
        <div className="w-full bg-gray-50 dark:bg-gray-900 p-4">
            <div className="max-w-md mx-auto">
                    ...
                    {prizes.map((prize: Prize, index: number) => (
                     ...
                     border border-gray-200 dark:border-gray-700"
                        >
                            ...
                            {/* Bottom Section */}
                            <div
                                className="flex justify-between items-center mt-4 pt-4 border-t border-gray-100 dark:border-gray-700">
                ...
                {/* Footer Message */}
                <div className="mt-8 p-4 bg-gradient-to-r from-blue-50 via-purple-50 to-pink-50
