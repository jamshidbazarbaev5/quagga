...
const UserDetails = ({user, totalPoints}: { user: any, totalPoints: number | undefined }) => {
        ...
        return (
            <div className="bg-gradient-to-r from-blue-500/10 to-blue-600/10 rounded-lg p-4">
                <div className="flex items-center justify-between">
                    <span className="text-gray-600 dark:text-gray-400 text-sm">{t('guest')}</span>
    ...
    return (
        <div className="pt-4 space-y-4">
            <div
                className="flex items-center space-x-3 border-b border-gray-200 dark:border-gray-700 pb-3  text-gray-600 dark:text-gray-400">
                <div className=" rounded-full p-1">
                    <User className="w-4 h-4"/>
                </div>
                <div>
                    <h3 className=" text-gray-600 dark:text-gray-400">
                        {user.first_name || t('no_name')} {user.last_name || t('no_last_name')}
                    </h3>
                </div>
            </div>
            ...
            <div className="flex items-center justify-between pt-2 border-t border-gray-200 dark:border-gray-700">
                <div
                    ...
                    <span className="text-sm text-gray-600 dark:text-gray-400">{t('totalPoints')}</span>
                </div>
